<div id="intro" class="container text-left bg-1">
        ...
        <h2 align="center">Pesan Tiket</h2>
<body>
    <table border=0>
        <form action="proses_pesanan.php" method="post">
<tr>
    <td>Jumlah Peserta</td>
    <td><input type="text" name="jumdew" placeholder ="Dewasa"></td>
    <td><input type="text" name="jumank" placeholder ="Anak"></td>
</tr>
<tr>
...
<td>Nama</td><td><input name="nama"  size="25" class="texbox"></td></tr>
<tr><td>Email</td><td><input name="email"  size="25" class="texbox"></td></tr>
<tr><td>No.Telp</td><td><input name="telepon"  cols="25" rows="3" class="texbox"></td></tr>
<tr><td>Pilihan Wisata</td><td><select name="wisata" class="texbox">
<option value="pilih">--Pilih--</option>
<option value="Borud">Borobudur</option>
<option value="Pramban">Prambanan</option>
<option value="Pinus">Hutan Pinus</option>
</select></td></tr>
<tr><td><input type="submit" value="pesan" class="btn"></td></tr>
</form>
</table>